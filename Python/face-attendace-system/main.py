...
img_background = cv2.imread(
    "C://Users//Mohak//Desktop//NXtech-Python//NXTECH-Python-Task-Number-3//Resources/background.png"
)
...
file = open(
    "C://Users//Mohak//Desktop//NXtech-Python//NXTECH-Python-Task-Number-3//EncodeFile.p",
    "rb",
)
        ...
        if counter != 0:
            if counter == 1:
                ...
                if secondElapsed > 86400:
                    ...
                    modeType = 3
                    counter = 0
                    img_background[44 : 44 + 633, 808 : 808 + 414] = imgmodeList[
                        modeType
                    ]
